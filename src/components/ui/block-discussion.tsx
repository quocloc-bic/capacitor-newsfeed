...
import { commentsPlugin } from "@/components/text-editor/plugins/comments-plugin";
import {
  type TDiscussion,
  discussionPlugin,
} from "@/components/text-editor/plugins/discussion-plugin";
import { suggestionPlugin } from "@/components/text-editor/plugins/suggestion-plugin";
